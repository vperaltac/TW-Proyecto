...
echo <<< HTML
    <footer>
        <p> <a href="https://www.ugr.es/estudiantes/grados/grado-ingenieria-informatica/tecnologias-web-tecnologias-informacion" target="_blank">&copy; 2020 Tecnologías Web,</a> <a href="mailto:victorperalta@correo.ugr.es"> Víctor Peralta Cámara,</a> <a href="mailto:jesusruiz@correo.ugr.es"> Jesús Ruiz Castellano</a> | <a href="#">Mapa del sitio</a> | <a href="documentacion.pdf" target="_blank"> Documentación</a></p>
    </footer>
HTML;
}